...
def create_list_help() -> str:
    ...
    lines.append("")
    lines.append(
        _formatter.description("Shows all supported brokers, data sources, and time granularities")
    )
    lines.append(
        _formatter.description(
            "available for use in strategy deployment. Essential for discovering"
        )
    )
    lines.append(
        _formatter.description("what options are supported before configuring your strategies.")
    )
    lines.append("")
...
def create_list_epilog() -> str:
    ...
    lines.append(
        f"  {_formatter.highlight('granularities')} {_formatter.description('Show supported data granularities')}"
    )
    lines.append(
        f"  {_formatter.highlight('strategies')}    {_formatter.description('Show available strategies')}"
    )
    lines.append("")
