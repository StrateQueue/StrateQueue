...
class SetupCommand(BaseCommand):
    ...
    def validate_args(self, args: argparse.Namespace) -> Optional[List[str]]:
        ...
        if not QUESTIONARY_AVAILABLE and not args.docs:
            return ["Interactive setup requires 'questionary' package. Install with: pip install questionary"]
        return None
    ...
    def execute(self, args: argparse.Namespace) -> int:
        ...
        if setup_type == 'broker':
            ...
            if broker_name:
                ...
                print(f"💡 Test your setup with: stratequeue status")
                return 0
            else:
    ...
    def _interactive_broker_setup(self) -> Optional[str]:
        """
    ...
    def _setup_alpaca(self) -> Optional[str]:
    ...
    def _interactive_data_provider_setup(self) -> Optional[str]:
        """
        ...
        try:
            ...
            provider_choice = select(
                "Select data provider to configure:",
    ...
    def _setup_polygon(self) -> Optional[str]:
    ...
    def _setup_coinmarketcap(self) -> Optional[str]:
    ...
    def _show_data_provider_docs(self, provider_name: Optional[str] = None) -> None:
